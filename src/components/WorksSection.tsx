    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-20 md:py-32">
        ...
        {/* <div className="mt-10 md:mt-14 flex items-center justify-center">
          <a
            href="#"
            className="group flex items-center gap-3 text-sm font-mono tracking-[0.25em] uppercase text-neutral-400 hover:text-red-600 transition-colors duration-300"
          >
            <span className="h-px w-8 bg-neutral-700 group-hover:w-14 group-hover:bg-red-600 transition-all duration-300" />
            View All Projects
            <span className="h-px w-8 bg-neutral-700 group-hover:w-14 group-hover:bg-red-600 transition-all duration-300" />
          </a>
        </div> */}
